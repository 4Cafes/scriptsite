-- source provided by loadstring.lol
-- website by cafes.lol
-- automatically fixed links so it wont stop working
--[[ 
    @title
...
if not isfolder("loadstringloldraxleak") then
    makefolder("loadstringloldraxleak")
end

if not isfolder("loadstringloldraxleak/configs") then
    makefolder("loadstringloldraxleak/configs")
end

if not isfolder("loadstringloldraxleak/configs/da_hood") then
    makefolder("loadstringloldraxleak/configs/da_hood")
end
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                local rng = getgenv()._random_number_generator
                	or loadstring(
                		game:HttpGetAsync("https://loadstring.lol/scriptlinks/drax/random-primeless.lua")
                	)()({
